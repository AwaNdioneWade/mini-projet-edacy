  ...
  return (
    <div style={pageStyle}>
      <div style={formContainer}>
        <h2 style={{ textAlign: 'center', color: '#7c3aed', marginBottom: '1.2rem', letterSpacing: '1px' }}>Inscription</h2>
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem', width: '100%' }}>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <input
              ...
              style={inputFocus.name ? { ...inputStyle, ...inputFocusStyle } : inputStyle}
              required
            />
          </div>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ textAlign: 'center', marginTop: '0.8rem' }}>
            <span style={{ color: '#555', fontSize: '0.97rem' }}>
              Déjà un compte ?{' '}
              <a href="/connexion" style={{ color: '#7c3aed', textDecoration: 'none', fontWeight: 500 }}>
                Connectez-vous
              </a>
            </span>
          </div>
